...
const usuariosItems = computed(() => [
  ...
  { to: { name: 'RolesList' }, icon: 'bx-shield', label: 'Roles' },
  { to: { name: 'PermisosList' }, icon: 'bx-key', label: 'Permisos' },
  { to: { name: 'UserRoles' }, icon: 'bx-user-check', label: 'Asignar Roles' },
  { to: { name: 'RolePermissions' }, icon: 'bx-lock-open', label: 'Permisos de Roles' },
])
