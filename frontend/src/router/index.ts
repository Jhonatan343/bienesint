...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    path: '/roles',
    name: 'RolesList',
    component: () => import('@/views/usuarios/RolesList.vue'),
    meta: { requiresAuth: true, roles: ['Administrador'] },
  },
  {
    path: '/permisos',
    name: 'PermisosList',
    component: () => import('@/views/usuarios/PermisosList.vue'),
    meta: { requiresAuth: true, roles: ['Administrador'] },
  },
  {
    path: '/user-roles',
    name: 'UserRoles',
    component: () => import('@/views/usuarios/UserRoles.vue'),
    meta: { requiresAuth: true, roles: ['Administrador'] },
  },
  {
    path: '/role-permissions',
    name: 'RolePermissions',
    component: () => import('@/views/usuarios/RolePermissions.vue'),
    meta: { requiresAuth: true, roles: ['Administrador'] },
  },
  {
    path: '/import-export',
