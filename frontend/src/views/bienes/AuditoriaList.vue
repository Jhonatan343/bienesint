        ...
        <div class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
              <tr
                v-for="registro in filteredAuditoria"
                :key="registro.id"
              ...
              >
                ...
                <td class="px-6 py-4">{{ registro.accion }}</td>
                <td class="px-6 py-4">{{ registro.usuario || 'N/A' }}</td>
                <td class="px-6 py-4 max-w-xs truncate">
                  <span v-if="registro.detalles">{{ registro.detalles }}</span>
                  <span v-else class="text-gray-400">Sin detalles</span>
                </td>
                <td class="px-6 py-4">{{ formatDate(registro.fecha) }}</td>
                <td class="px-6 py-4">{{ registro.ip || 'N/A' }}</td>
              </tr>
            </tbody>
          </table>
        </div>
