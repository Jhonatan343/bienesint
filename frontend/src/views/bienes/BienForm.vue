            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                >
                  ...
                  <option value="oficina_administrativa">Oficina Administrativa</option>
                  <option value="oficina_sistemas">Oficina de Sistemas</option>
...
export default {
  ...
  setup() {
    ...
    onMounted(async () => {
      ...
      await Promise.all([loadUsuarios(), loadPeriodos()])
