    ...
    <div class="toolbar">
      <div class="toolbar-left">
        ...
        <div class="filters-container">
          ...
          <select v-model="filtroUbicacion" class="filter-select" @change="filtrarBienes">
            <option value="">
            ...
            <thead>
              <tr>
                ...
                <th class="sortable" @click="ordenarPor('nombre')">
                  Nombre
                  <i :class="getSortIcon('nombre')" />
                </th>
                <th>Categoría</th>
                <th>Ubicación</th>
                <th class="sortable" @click="ordenarPor('estado')">
                  Estado
                  <i :class="getSortIcon('estado')" />
                </th>
                <th class="sortable" @click="ordenarPor('valor')">
                  Valor
                  <i :class="getSortIcon('valor')" />
                </th>
                  ...
                  <div class="action-buttons-cell">
                    ...
                    <div class="dropdown">
                      ...
                      <div v-if="dropdownAbierto === bien.id" class="dropdown-menu">
                        ...
                        <a class="dropdown-item" @click.stop="solicitarTraslado(bien)">
